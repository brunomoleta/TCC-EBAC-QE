...
class CatalogPage {
  ...
  async homePageProducts() {
    ...
    const thirdChildText =
      "Womens Wingtip Shoes Handmade Sheepskin Full Brogues Oxfords & Tie Flats";
  ...
  async allProductsPage() {
    const descriptionOne =
      "Handmade Leather Donddi sandals For Women, R$ 83, R$ 90";
    const descriptionTwo = "Ingrid Running Jacket, R$ 65, R$ 70";
    const descriptionThree =
      "Womens Wingtip Shoes Handmade Sheepskin Full Brogues Oxfords & Tie Flats, R$ 104, R$ 110";
  ...
  async getShoesProducts() {
    const description =
      "Womens Wingtip Shoes Handmade Sheepskin Full Brogues Oxfords & Tie Flats, R$ 104, R$ 110";
    await this.helper.checkElementDisplayByText(description, false);
  }
  async getErrorMessage() {
    const error = "No products found";
    await this.helper.getElementByXPath(error);
  }
}
