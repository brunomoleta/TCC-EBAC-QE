Feature: addToCart
  ...
  Scenario Outline: Quantidade excessiva de um produto no <browser>
  ...
  Scenario Outline: Desconto automático de 15% no <browser>
  ...
  Scenario Outline: Desconto automático de 10% no <browser>
  ...
  Scenario Outline: Valor total do carrinho maior que o permitido
